...
if os.path.isfile(caffe_root + 'models/finetune-xray-alexnet-shuffle/finetune_alexNet_xray_iter_50000.caffemodel'):
...
model_weights = caffe_root + 'models/finetune-xray-alexnet-shuffle/finetune_alexNet_xray_iter_50000.caffemodel'
...
predict_array = []
groundtruth_array = []
test_file = open('data/alexnet-xray-shuffle/train.txt', "r+")
