...
class uec(imdb):
    ...
    def gt_roidb(self):
        ...
        gt_roidb = [self._load_uec_annotation(index)
    ...
    def _load_uec_annotation(self, index):
        """
	...
	objs = re.findall('\d+ \d+ \d+ \d+ \d+', data)
	    ...
	    #coor = re.findall('\d+', obj)
            ...
            x2 = float(coor[3])
            y2 = float(coor[4])
	    #print "***load_annoation****: ", x1, y1, x2, y2
            cls = self._class_to_ind['rice']
    ...
    def _write_uec_results_file(self, all_boxes):
        for cls_ind, cls in enumerate(self.classes):
            if cls == '__background__':
                continue
            print 'Writing {} results file'.format(cls)
            filename = self._get_uec_results_file_template().format(cls)
    ...
    def evaluate_detections(self, all_boxes, output_dir):
        self._write_uec_results_file(all_boxes)
    ...
    def _get_uec_results_file_template(self):
