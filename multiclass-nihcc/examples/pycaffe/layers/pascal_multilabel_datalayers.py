...
class BatchLoader(object):
	...
	##### here it uses the params that is train.txt or val.txt, not XXX_train.txt or XXX_test.txt
	print "#####BatchLoader use the txt: ", list_file
        print_info("BatchLoader use the txt", params)
